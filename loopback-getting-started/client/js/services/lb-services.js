 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/CoffeeShops/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use CoffeeShop.coffeeShop() instead.
            "prototype$__get__coffeeShop": {
              url: urlBase + "/CoffeeShops/:id/coffeeShop",
              method: "GET",
            },
        ...
        */
        R.modelName = "CoffeeShop";
            ...
            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop#coffeeShop
             * @methodOf lbServices.CoffeeShop
             *
             * @description
             *
             * Busca relação coffeeShop de belongsTo.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - CoffeeShop id
        ...
        R.coffeeShop = function() {
          ...
          var action = TargetResource["::get::CoffeeShop::coffeeShop"];
     ...
     */
             ...
             * @description
             *
             * reviews consultas de CoffeeShop.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - CoffeeShop id
        ...
        R.reviews = function() {
          ...
          return action.apply(R, arguments);
             ...
             * @description
             *
             * reviews contagens de CoffeeShop.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - CoffeeShop id
        ...
        R.reviews.count = function() {
          ...
          return action.apply(R, arguments);
             ...
             * @description
             *
             * Cria uma nova instância no reviews deste modelo.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - CoffeeShop id
        ...
        R.reviews.createMany = function() {
          ...
          return action.apply(R, arguments);
             ...
             * @description
             *
             * Exclui todos os reviews deste modelo.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - CoffeeShop id
        ...
        R.reviews.destroyAll = function() {
          ...
          return action.apply(R, arguments);
             ...
             * @description
             *
             * Excluir um item relacionado por ID para reviews.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - CoffeeShop id
             ...
             *  - `options` – `{object=}` -
             *
             *  - `fk` – `{*}` - Chave estrangeira para reviews
             *
             *  - `options` – `{object=}` -
             *
             * @param {function(Object,Object)=} successCb
        ...
        R.reviews.destroyById = function() {
          ...
          return action.apply(R, arguments);
             ...
             * @description
             *
             * Localize um item relacionado por ID para reviews.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - CoffeeShop id
        ...
        R.reviews.findById = function() {
          ...
          return action.apply(R, arguments);
             ...
             * @description
             *
             * Atualizar um item relacionado por ID para reviews.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - CoffeeShop id
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        */
        R.modelName = "Review";
             ...
             * @description
             *
             * Busca relação reviewer de belongsTo.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Review id
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Reviewers/:id",
          { 'id': '@id' },
          {
             ...
             * @description
             *
             * accessTokens consultas de Reviewer.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Reviewer id
             ...
             * @description
             *
             * accessTokens contagens de Reviewer.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Reviewer id
